import type { LoaderPlugin } from "https://deno.land/x/aleph@v0.3.0-alpha.28/types.ts";
      ...
      if (framework === "react") {
        return {
          code: [
            ...
            `import HtmlPage from 'https://deno.land/x/aleph@v0.3.0-alpha.28/framework/react/components/HtmlPage.ts'`,
